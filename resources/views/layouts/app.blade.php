...
<head>
    <meta charset="UTF-8">
    <title>Admin Dira Abinawa</title>
...
<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="/">
        <img class="p-1" src="{{asset('assets/images/logosu.png')}}" style="width: 150px" alt="">
    </a>
...
<footer class="app-footer">
    <div class="ml-auto">
        ...
        <a href="https://coreui.io">Tim IT DKR Padalarang</a>
        <span>&copy; Version 1.0</span>
